...
const typed = new Typed('#prompts-sample', {
    ...
    "Como está o estoque?",
    "Gere gráficos de vendas",
    "Previsão financeira para o próximo trimestre",
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  const contactButtons = document.querySelectorAll('.contact-button, .btn-contact, a[href="#contact"], a:contains("Entre em contato"), a:contains("Contato"), .btn span:contains("Entre em contato")').closest('a');
